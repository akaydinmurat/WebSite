...
export function ContactCta() {
  ...
  return (
    <section
      ...
      className="contact-cinema section-tone-dark relative flex min-h-[100svh] items-end overflow-hidden bg-[var(--color-oxblood)] py-12 text-[var(--color-paper)] md:py-20"
    ...
    >
      ...
      <div className="site-shell section-frame relative">
        <SectionMarker index="06" label="Yeni Proje" meta="İlk görüşme" />
        <p className="eyebrow mb-10 text-white/68">{copy.eyebrow}</p>
        <h2
          id="contact-cta-title"
          className="contact-cinema-title max-w-[12ch] font-serif font-normal"
        >
          {copy.title}
        </h2>
