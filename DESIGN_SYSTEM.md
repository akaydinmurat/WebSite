...
| ---------------------- | ----------- | -------------------------------------- |
| `--color-canvas`       | `#eae2d6`   | Ana sıcak kireç taşı arka planı        |
| `--color-canvas-deep`  | `#d8c8b5`   | Kum tonlu ikincil yüzey                |
| `--color-paper`        | `#f6f1e9`   | Fildişi vurgu ve koyu yüzey üstü metin |
| `--color-ink`          | `#181511`   | Espresso ana metin ve güçlü kontroller |
| `--color-ink-soft`     | `#4a423a`   | Uzun metin ve ikincil açıklama         |
| `--color-muted`        | `#554c43`   | AA doğrulanmış yardımcı metadata       |
| `--color-accent`       | `#9b4f2f`   | Perdahlı bakır vurgu ve focus rengi    |
| `--color-accent-warm`  | `#d0a56b`   | Koyu yüzeyde pirinç vurgu              |
| `--color-night`        | `#171411`   | Sinematik espresso bölümler            |
| `--color-night-soft`   | `#241e19`   | İkincil koyu bölüm                     |
| `--color-oxblood`      | `#5a2f28`   | İletişim odası için bordo yüzey        |
